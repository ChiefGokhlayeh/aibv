...
Die \foreignlanguage{english}{Accuracy} dieser Variante beläuft sich auf \SI{90.72}{\percent} bei \(k = 1\) und \SI{83.51}{\percent} bei \(k = 3\). Bei Betrachtung der \foreignlanguage{english}{Confusion Matrix} ist eine ähnliche Verteilung wie in \nameref{sct:variant1} zu erkennen.
